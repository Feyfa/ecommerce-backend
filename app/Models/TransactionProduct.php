...
class TransactionProduct extends Model
{
     ...
     *
     * @return BelongsTo<TransactionUser, TransactionProduct> Relasi Eloquent menuju transaksi seller pemilik item.
     */
     ...
     *
     * @return BelongsTo<Product, TransactionProduct> Relasi Eloquent menuju produk sumber item transaksi.
     */
